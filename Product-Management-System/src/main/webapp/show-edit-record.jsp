  ...
  <form action="update-record.jsp" method="post">
    <table class="taf">
      ...
      <tr>
        ...
        <td><input type="text" name="name" class="tb" value="<%= product.getName() %>" required></td>
      </tr>
      <tr>
        <td>Edit Product Brand</td>
        <td><input type="text" name="brand" class="tb" value="<%= product.getBrand() %>" required></td>
      </tr>
      <tr>
        <td>Edit Product Price</td>
        <td><input type="text" name="price" class="tb" value="<%= product.getPrice() %>" required></td>
      </tr>
      <tr>
